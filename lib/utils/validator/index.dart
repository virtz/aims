class Validators {
  ...
  String? confirm(value, confirmValue, key) {
    if (value != confirmValue) {
      return 'Password and ConfirmPasssword don\'nt match';
    }
    return null;
  }

  String? isLessThan3(value) {
    if (value.length >= 3) {
